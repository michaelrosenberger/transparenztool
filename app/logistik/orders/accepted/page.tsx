    ...
    <>
      <Container dark fullWidth>
        <div className="flex items-center justify-between mb-6 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div>
            <h1>Akzeptierte Bestellungen</h1>
            <p>Alle für die Logistikverarbeitung akzeptierten Bestellungen anzeigen</p>
          </div>
        </div>
      </Container>
        ...
        {orders.length === 0 ? (
          <Card>
            <div className="text-center py-12">
              <p>Noch keine akzeptierten Bestellungen</p>
            </div>
          </Card>
        ) : (
          <Card>
            <h3 className="mb-4">Akzeptierte Bestellungen</h3>
