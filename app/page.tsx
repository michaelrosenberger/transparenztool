// ⚠️ TEMPORARY: Homepage replaced with meal/today content
// ⚠️ To restore original homepage, revert this file from git
"use client";
            ...
            (error) => {
              ...
              switch(error.code) {
                case error.PERMISSION_DENIED:
                  errorMessage = "User denied the request for Geolocation (or insecure origin)";
                  break;
