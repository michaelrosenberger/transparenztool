...
export default function BusinessProfilePage() {
  ...
  useEffect(() => {
    const checkUser = async () => {
      ...
      setBusinessSubtext(metadata.business_subtext || "");
      setBusinessDescription(metadata.business_description || "");
      setStreet(metadata.street || "");
      setZipCode(metadata.zip_code || "");
      setCity(metadata.city || "");
      setVegetables(metadata.vegetables || []);
      setImages(metadata.business_images || []);
      setFeaturedImageIndex(metadata.featured_image_index || 0);
    ...
    <>
      <Container dark fullWidth>
        <div className="flex items-center justify-between mb-6 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div>
            <h1>Geschäftsprofil</h1>
            <p>Verwalten Sie Ihre Geschäftsinformationen</p>
          </div>
        </div>
      </Container>
      ...
      <Container asPage>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Beschreiben Sie Ihren Betrieb, Ihre Philosophie und Ihre Produkte..."
                rows={6}
                maxLength={1000}
              />
        ...
        <Card className="mb-6">
          ...
          <p className="mb-4 text-sm text-gray-600">
            Wählen Sie die Zutaten aus, die Sie anbauen (basierend auf aktiven Zutaten)
          </p>
          
          {availableIngredients.length === 0 ? (
            <p className="text-sm text-gray-500">
              Keine aktiven Zutaten verfügbar. Bitte kontaktieren Sie den Administrator.
            </p>
          ) : (
            <MultiSelect
              values={vegetables}
        ...
        <Card className="mb-6">
          ...
          <p className="mb-4 text-sm text-gray-600">
            Laden Sie Bilder Ihres Betriebs, Ihrer Felder oder Produkte hoch. Ziehen Sie Bilder, um die Reihenfolge zu ändern.
          </p>
          ...
          <div className="space-y-2">
            ...
            {images.length > 0 && (
              <div className="flex items-start gap-2 text-sm text-gray-600">
                ...
                <p>
                  Das Bild mit dem Stern ist Ihr Hauptbild und wird prominent auf der Produzentenliste angezeigt.
                </p>
              </div>
            )}
          </div>
